...
export const Home = () => {
  ...
  return (
    <div className="p-6 text-gray-400">
      ...
      <p className="my-2">
        Meu nome é <b>Leonardo Belini</b>, sou Desenvolvedor Full Stack, atuando
        como desenvolvedor á {yearWorking} anos. Já trabalhei em empresas como{' '}
        <a
          href="https://www.iteam.inf.br/"
          className="underline decoration-carmine"
          target="_blank"
        ...
        e atualmente no{' '}
        <a
          href="https://roberty.app/"
          className="underline decoration-carmine text-gray-400"
          target="_blank"
          rel="noopener noreferrer"
        >
          Roberty
